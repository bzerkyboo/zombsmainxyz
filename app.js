...
let wasmmodule = () => {
    ...
    const instantiate = (wasmbuffers) => {
        WebAssembly.instantiate(wasmbuffers, {
            "a" : {
                'd': () => {},
                'f': () => {},
                'c': () => [0, 0, 1, 0, 24][(Module.repeater %= 5, Module.repeater++)],
                'e': () => {},
                'b': () => (Module.HEAPU8.set(new Uint8Array([...new TextEncoder().encode(Module.hostname)]), 200), 200),
                'a': () => {}
            }
        }).then(asm => {
            Module.asm = asm.instance.exports;
            Module.HEAP32 = new Int32Array(Module.asm.g.buffer),
            Module.HEAPU8 = new Uint8Array(Module.asm.g.buffer)
            Module.asm.h();
            Module.HEAP32[35004] = 140000;
            Module.HEAP32[35005] = 0;
    ...
    wasmbuffers ? instantiate(wasmbuffers) : fetch("./zombs_wasm.wasm").then(e => e.arrayBuffer().then(r => {
...
([
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class TowerModel extends ModelEntity_1.default {
            ...
            updateModel(tier) {
                ...
                this.base = new SpriteEntity_1.default(`/pictures/${(this.name == "mage-tower" || this.name == "bomb-tower") ? this.name : "cannon-tower"}-t${tier}-base.svg`);
                this.head = new SpriteEntity_1.default(`/pictures/${this.name}-t${this.name !== "mage-tower" ? tier : 1}-head.svg`);
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class DoorModel extends ModelEntity_1.default {
            constructor() {
                super();
                this.currentTier = 1;
                this.base = new SpriteEntity_1.default(`/pictures/door-t${this.currentTier}-base.svg`);
                this.healthBar = new HealthBar_1.default();
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class GoldMineModel extends ModelEntity_1.default {
            constructor() {
                ...
                this.base = new SpriteEntity_1.default(`/pictures/cannon-tower-t${this.currentTier}-base.svg`);
                this.head = new SpriteEntity_1.default(`/pictures/gold-mine-t${this.currentTier}-head.svg`);                this.healthBar = new HealthBar_1.default();
                this.healthBar.setSize(82, 16);
                this.healthBar.setPivotPoint(82 / 2, -25);
                this.healthBar.setVisible(false);
                this.addAttachment(this.base, 2);
            ...
            updateModel(tick, networkEntity) {
                ...
                this.removeAttachment(this.head);
                this.base = new SpriteEntity_1.default(`/pictures/cannon-tower-t${this.currentTier}-base.svg`);
                this.head = new SpriteEntity_1.default(`/pictures/gold-mine-t${this.currentTier}-head.svg`);                this.addAttachment(this.base, 2);
                this.addAttachment(this.head, 3);
            };
            updateHealthBar(tick, networkEntity) {
                tick.health !== tick.maxHealth ? this.healthBar.setVisible(true) : this.healthBar.setVisible(false);
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class GoldStashModel extends ModelEntity_1.default {
            constructor() {
                super();
                this.currentTier = 1;
                this.base = new SpriteEntity_1.default(`/pictures/gold-stash-t${this.currentTier}-base.svg`);
                this.healthBar = new HealthBar_1.default();
                this.healthBar.setSize(82, 16);
                this.healthBar.setPivotPoint(82 / 2, -25);
                this.healthBar.setVisible(false);
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class HarvesterModel extends ModelEntity_1.default {
            ...
            updateModel(tier) {
                ...
                this.removeAttachment(this.head);
                this.base = new SpriteEntity_1.default(`/pictures/cannon-tower-t${this.currentTier}-base.svg`);
                this.head = new SpriteEntity_1.default(`/pictures/harvester-t${this.currentTier}-head.svg`);
                this.head.setPivotPoint(10, 0);
                this.claw = new SpriteEntity_1.default(`/pictures/harvester-t${this.currentTier}-claw.svg`);
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class MeleeTowerModel extends TowerModel_1.default {
            ...
            updateModel(tier) {
                ...
                this.removeAttachment(this.head);
                this.base = new SpriteEntity_1.default(`/pictures/cannon-tower-t${this.currentTier}-base.svg`);
                this.middle = new SpriteEntity_1.default(`/pictures/melee-tower-t${this.currentTier}-middle.svg`);
                this.middle.setAnchor(0, 0.5);
                this.middle.setPositionY(32);
                this.head = new SpriteEntity_1.default(`/pictures/melee-tower-t${this.currentTier}-head.svg`);
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class NeutralCampModel extends ModelEntity_1.default {
            constructor() {
                super();
                this.base = new SpriteEntity_1.default('/pictures/neutral-camp-base.svg');
        ...
        class NeutralModel extends CharacterModel_1.default {
            ...
            updateModel(tick, networkEntity) {
                ...
                if (tick.model.indexOf('NeutralTier') > -1) {
                    ...
                    this.base = new SpriteEntity_1.default("/pictures/neutral-t1-base.svg");
                    this.weapon = new SpriteEntity_1.default('/pictures/neutral-t1-weapon.svg');
        ...
        class PetModel extends CharacterModel_1.default {
            ...
            updateModel(tick, networkEntity) {
                ...
                if (tick.model.indexOf('PetCARL') > -1) {
                    this.base = new SpriteEntity_1.default(`/pictures/pet-carl-t${tick.tier}-base.svg`);
                    this.weapon = new SpriteEntity_1.default(`/pictures/pet-carl-t${tick.tier}-weapon.svg`);
                    this.weapon.setAnchor(0.5, 1);
                    this.weaponUpdateFunc = this.updateSwingingWeapon(300, 100);
                } else if (tick.model.indexOf('PetMiner') > -1) {
                    this.base = new SpriteEntity_1.default(`/pictures/pet-miner-t${tick.tier}-base.svg`);
                    this.weapon = new SpriteEntity_1.default(`/pictures/pet-miner-t${tick.tier}-weapon.svg`);
                    this.weapon.setAnchor(0.5, 1);
                    this.weaponUpdateFunc = this.updateSwingingWeapon(300, 100);
                } else {
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class PlayerModel extends CharacterModel_1.default {
            constructor() {
                super();
                this.base = new SpriteEntity_1.default('/pictures/player-base.svg');
                this.healthBar = new HealthBar_1.default();
            ...
            updateWeapon(tick, entity) {
                ...
                switch (tick.weaponName) {
                    case 'Pickaxe':
                        let pickaxe;
                        pickaxe = new SpriteEntity_1.default(`/pictures/player-pickaxe-t${tick.weaponTier}.svg`);
                        pickaxe.setAnchor(0.5, 1);
                        this.weapon = pickaxe;
                        this.weaponUpdateFunc = this.updateSwingingWeapon(250, 100);
                        break;
                    case 'Spear':
                        let spear = new SpriteEntity_1.default(`/pictures/player-spear-t${tick.weaponTier}.svg`);
                        spear.setAnchor(0.5, 1);
                        this.weapon = spear;
                        this.weaponUpdateFunc = this.updateSwingingWeapon(250, 100);
                        break;
                    case 'Bow':
                        let bow = new SpriteEntity_1.default(`/pictures/player-bow-t${tick.weaponTier}.svg`);
                        let bowHands = new SpriteEntity_1.default(`/pictures/player-bow-t${tick.weaponTier}-hands.svg`);
                        ...
                        break;
                    case 'Bomb':
                        let bomb = new SpriteEntity_1.default(`/pictures/player-bomb-t${tick.weaponTier}.svg`);
                        let bombHands = new SpriteEntity_1.default(`/pictures/player-bomb-hands.svg`);
            ...
            updateHat(tick, entity) {
                ...
                switch (tick.hatName) {
                    case 'HatHorns':
                        this.hat = new SpriteEntity_1.default('/pictures/hat-horns-base.svg');
                        break;
                    default:
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class ProjectileArrowModel extends ModelEntity_1.default {
            constructor() {
                super();
                this.base = new SpriteEntity_1.default('/pictures/arrow-tower-projectile.svg');
                this.addAttachment(this.base);
            }
        }
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class ProjectileBombModel extends ModelEntity_1.default {
            constructor() {
                super();
                this.base = new SpriteEntity_1.default('/pictures/bomb-tower-projectile.svg');
                this.addAttachment(this.base);
            }
        }
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class ProjectileCannonModel extends ModelEntity_1.default {
            constructor() {
                super();
                this.base = new SpriteEntity_1.default('/pictures/cannon-tower-projectile.svg');
                this.addAttachment(this.base);
            }
        }
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class ProjectileMageModel extends ModelEntity_1.default {
            constructor() {
                super();
                this.base = new SpriteEntity_1.default('/pictures/mage-tower-projectile.svg');
                this.addAttachment(this.base);
            }
        }
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class SlowTrapModel extends ModelEntity_1.default {
            constructor() {
                super();
                this.currentTier = 1;
                this.base = new SpriteEntity_1.default(`/pictures/slow-trap-t${this.currentTier}-base.svg`);
                this.healthBar = new HealthBar_1.default();
                this.healthBar.setSize(35, 10);
                this.healthBar.setPivotPoint(35 / 2, -8);
                this.healthBar.setVisible(false);
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class WallModel extends ModelEntity_1.default {
            constructor() {
                super();
                this.currentTier = 1;
                this.base = new SpriteEntity_1.default(`/pictures/wall-t${this.currentTier}-base.svg`);
                this.healthBar = new HealthBar_1.default();
                this.healthBar.setSize(35, 10);
                this.healthBar.setPivotPoint(35 / 2, -8);
                this.healthBar.setVisible(false);
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class ZombieBossModel extends CharacterModel_1.default {
            ...
            updateModel(tick, networkEntity) {
                ...
                this.base = new SpriteEntity_1.default('/pictures/zombie-boss-t1-base.svg');
                this.weapon = new SpriteEntity_1.default('/pictures/zombie-boss-t1-weapon.svg');
                this.weapon.setAnchor(0.5, 1);
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class ZombieModel extends CharacterModel_1.default {
            ...
            updateModel(tick, networkEntity) {
                ...
                this.base = new SpriteEntity_1.default(`/pictures/zombie-${color.toLowerCase()}-t${tier}-base.svg`);
                this.weapon = new SpriteEntity_1.default(`/pictures/zombie-${color.toLowerCase()}-t${tier}-weapon.svg`);
                this.weapon.setAnchor(0.5, 1);
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class Renderer extends events.EventEmitter {
            constructor(forceCanvas = false) {
                ...
                this.renderer = PIXI.autoDetectRenderer({backgroundColor: 0x222222});
            ...
            onEnterWorld(data) {
                ...
                if (!document.useRequiredEquipment) {
                    ...
                    if (game.network.socket) {
                        for (let i = 0; i < 26; i++) game.network.socket.send(new Uint8Array([3, 17, 123, 34, 117, 112, 34, 58, 49, 44, 34, 100, 111, 119, 110, 34, 58, 48, 125]));
...
<input type="text" maxlength="20" placeholder="partyKey" id="myKey" style="width: 50%; height: 40px;" button="" class="btn btn-grey">
<button class=\"btn btn-blue" style=\"width: 50%;\" onclick="join();">Join</button>
<input type="text" maxlength="20" placeholder="partyKey" id="myKey2" style="width: 50%; height: 40px;" button="" class="btn btn-grey">
<button class=\"btn btn-blue" style=\"width: 50%;\" onclick="join2();">Join</button>
</div>
</div>
<div class="mainygrid">
<h3>~ Y ~</h3>
...
`
                        ...
                        $7[7].addEventListener("click", () => {
                            document.show48x48Grid = !document.show48x48Grid;
                            if (document.show48x48Grid) {
                                add48x48Grid();
...
<button class="mx" onclick="opengridthing('x');" style="width: 27%">~ X ~</button>
<button class="my" onclick="opengridthing('y');" style="width: 27%">~ Y ~</button>
<button class="mz" onclick="opengridthing('z');" style="width: 27%">~ Z ~</button>
`;
                        opengridthing();
                        let added = false;
                        let added2 = false;
                        const mapTexture = PIXI.Texture.from('http://localhost/pictures/map_1.png');
                        const map2Texture = PIXI.Texture.from('http://localhost/pictures/map_2.png');
                        let grassTexture;
                        let grass2Texture;
                        const lines = [];
                        const makeBoarder = (x, y, width, height, shouldAddInArray, colorType = "red") => {
                            let obj = new PIXI.Graphics();
                            obj.beginFill(colorType == "red" ? 0xff0000 : colorType == "yellow" ? 0xFFFF00 : colorType == "green" ? 0x008000 : colorType == "blue" ? 0x0000FF : 0xff0000);
                        ...
                        const add48x48Grid = () => {
                            if (added2) return;
                            added2 = true;
                            grass2Texture = new PIXI.TilingSprite(map2Texture);
                            grass2Texture.x = 0;
                            grass2Texture.y = 0;
                            grass2Texture.width = 24000;
                            grass2Texture.height = 24000;
                            grass2Texture.anchor.x = 0;
                            grass2Texture.anchor.y = 0;
                            game.world.renderer.entities.node.addChild(grass2Texture);
                        }
                        const delete48x48Grid = () => {
                            if (!added2) return;
                            added2 = false;
                            grass2Texture.destroy();
                        }
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class BinNetworkAdapter extends NetworkAdapter_1.default {
            ...
            onMessage(event) {
                ...
                if (data[0] == 5) {
                    Module.onDecodeOpcode5(data, game.network.connectionOptions.ipAddress, decodedopcode5 => {
                        game.network.sendPacket(4, {displayName: localStorage.name, extra: decodedopcode5[5]});
                        game.network.enterworld2 = decodedopcode5[6];
                    });
                    return;
                }
                if (data[0] == 10) {
                    game.network.socket.send(Module.finalizeOpcode10(data));
                    return;
                }
        ...
        class NetworkAdapter {
            ...
            addPreEnterWorldHandler(callback) {
                this.addPacketHandler(5, (response) => {
                    wasmmodule(response.extra, game.network.connectionOptions.ipAddress).then((e) => {
    ...
    /***/ ((module, exports, __webpack_require__) => {
        ...
        class BinCodec {
            ...
            decodePreEnterWorldResponse(buffer) {
                return {
                    extra: new Uint8Array(buffer.buffer)
                };
            }
            decodeEnterWorldResponse(buffer) {
                let allowed = buffer.readUint32();
            ...
            constructor(ui) {
                ...
                this.steps = {
                    '1': {
                        ...
                        icon: '/pictures/65698807-c047-4e77-bf51-7937b4cef560_entities-gold-mine[1].svg'
                    },
                    '2': {
                        ...
                        icon: '/pictures/65698807-c047-4e77-bf51-7937b4cef560_entities-gold-stash[1].svg'
                    },
                    '3': {
                        ...
                        icon: '/pictures/65698807-c047-4e77-bf51-7937b4cef560_entities-arrow-tower[1].svg'
                    },
                    '4': {
    ...
    ((module, exports, __webpack_require__) => {
        ...
        class UiMenuFPS extends UiComponent_1.default {
            constructor(ui) {
                super(ui, "<div id=\"hud-menu-FPS\" class=\"hud-menu hud-menu-FPS\">\n            <a class=\"hud-menu-close\"></a>\n            <h3>FPS</h3>\n            <div class=\"hud-FPS-grid\">\n  <span>FPS Optimize Testing</span>\n<br><br><br>                    <a class=\"hud-FPS-restart-walkthrough btn btn-green\">Disable Tower Sprite Entity</a>\n<br>                    <a class=\"hud-FPS-restart-walkthrough btn btn-green\">Disable Tower Entity</a>\n<br>                    <a class=\"hud-FPS-restart-walkthrough btn btn-green\">Disable Projectile Entity</a>\n<br>                    <a class=\"hud-FPS-restart-walkthrough btn btn-green\">Disable Zombie Sprite Entity (Excluding Bosses)</a>\n<br>                    <a class=\"hud-FPS-restart-walkthrough btn btn-green\">Disable Zombie Entity (Excluding Bosses)</a>\n<br>                    <a class=\"hud-FPS-restart-walkthrough btn btn-green\">Stop Rendering</a>\n<br>                    <a class=\"hud-FPS-restart-walkthrough btn btn-green\">Show 200x200 Grid</a>\n<br>                    <a class=\"hud-FPS-restart-walkthrough btn btn-green\">Show 48x48 Grid</a>\n<br>                    <a class=\"hud-FPS-restart-walkthrough btn btn-green\" onclick=\"autoreconnectr()\">Enable Auto Reconnect</a>\n<br>      </div>");
                this.closeElem = this.componentElem.querySelector('.hud-menu-close');
